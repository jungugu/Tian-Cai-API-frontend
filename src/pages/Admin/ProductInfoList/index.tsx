...
import ProductInfoModalFormColumns, {ProductInfoColumns} from "@/pages/Admin/Colums/ProductInfoColumns";
import {
  addProductInfoUsingPOST,
  deleteProductInfoUsingPOST,
  listProductInfoByPageUsingPOST,
  onlineHandleUsingPOST,
  updateProductInfoUsingPOST
} from "@/services/tianCaiAPI/productInfoController";
import {offlineInterfaceInfoUsingPOST} from "@/services/tianCaiAPI/interfaceInfoController";
...
const ProductInfoList: React.FC = () => {
  ...
  const handleOnline = async (record: API.IdRequest) => {
    ...
    try {
      const res = await onlineHandleUsingPOST({
        id: record.id,
      });
      hide();
      if (res.data) {
    ...
    <Card>
      ...
      <ProTable<API.ProductInfo>
        ...
        request={async (params) => {
          setLoading(true)
          const res = await listProductInfoByPageUsingPOST({...params});
          if (res.data) {
            setLoading(false)
            return {
